...
Throughout the term, there will be key concepts introduced related the digital technology, digital culture, and globalization (e.g. "neoliberalism"). It's important to recognize that concepts are not static. The evolve over time. Sometimes, they evolve even in the course of one's own career (e.g. Judith Butler's concept of "performativity"). So keep in mind that concepts, and the language we use to discuss them, change. While we may turn to certain people as authorities on certain concepts, even those authorities often struggle with pinning down their meaning. The same can be said for concepts in the sciences and math, but concepts tend to be even more flexible in the human/social or moral-aesthetic domain.
...
Students will encounter a number of critics, historians, and theorists throughout the term, and will have opportunities to compare, contrast, and synthesize these theories and outlooks. Unlike in the History of Text Technologies, we will largely focus on contemporary digital tech. That said, we may evaluage different versions of the same contemporary technology (e.g. "Which search engine is the most racist?").
...
In this class we will largely use theories and analytic methods from Marxim, psychoanlaysis, poststructuralism, and posthumanism, especially with respect to the terms "identity," "individual," "subject," "citizen," and so forth. Our methods will also derive from rhetoric and sociology.  
...
One of the fundamental questions of this class is: Who is included and excluded as a digital identity? We can abbreviate this question: Who matters? But we probably need to add: Who matters digitally? Along similar lines, we wiil ask, how do digital spaces contribute to the construction of a subject and an identity? We will also consider how digital platforms, especially video games, facilitate communities. Last, we will think about how digital technology determines who is a citizens and the citizen's relaitonship to the state.  
...
Students will write traditional, college-level research papers, but they will also create multimodal projects involving visual, linguistic, and possibly an array of other modes.
...
Rather than ask students to wait until the end of the course to share their personal thoughts and feelings with respect to course materials, each module will end with a reflection. Students will complete three reflections overall. 
