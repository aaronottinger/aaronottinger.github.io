...
With the digital age it might seem that we are past all of the above. As it turns out, rather than dismantling the above scenarios, the internet has to a large extent merely recoded them. People from marginalized communities might be able to upset present-day power dynamics in carnivaliesque acts of masquerade online. More likely, the internet, including social media, search engines, video games, and data bases are used to reinforce white supremacy and systemic racisim, reinforcing particular identities and power dynamics. In part, this class explores how the supposed liberation that digital technology was supposed to bring about merely transformed forms of oppression inherited from the age before, in what Ruha Benjamin calls "the New Jim Code." To examin this process in action, in the first module students will analyze search engines, in the manner of Sofiya Umoja Noble, and assess if the information they provide is "the best" or if it is, on the contrary, racist, misogynystic, or violent in some other respect. 

As students of Digital Technology and Cultures, we will not only analyze what "is." Remaining committed to social justice, we will also imagine ways to remake the digital domain as more inclusive and equitable, for example, by designing 
